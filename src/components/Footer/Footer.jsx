...
import { LinkedIn, GithubIcon, TwitterIcon } from "../Icons";
...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 rounded-2xl bg-dark m-10 flex flex-col items-center text-light  ">
      <h3 className="mt-16 font-medium text-centert capitalize text-4xl px-4">
      ...
      <div className="flex items-centermt-8 mt-2">
        ...
        <a href={siteMetadata.github} className="w-6 h6 mr-4 inline-block">
          <GithubIcon className="hover:scale-125 transition-all ease duration-200 fill-white" />
        </a>
        <a href={siteMetadata.github} className="w-6 h6 mr-4 inline-block ">
      ...
      <div className="w-full mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex flex-row items-center justify-between  ">
        <span className="text-center">
          &copy; 2024 Feisal Keli. All rights reserved.
        </span>
