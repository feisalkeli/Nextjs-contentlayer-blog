...
const AboutCoverSection = () => {
  return (
    <section className="w-full h-[75vh] border-b-2 border-solid border-dark flex flex-row items-center justify-center text-dark">
      <div className="w-1/2 h-full border-r-2 border-solid border-dark flex justif- center">
        <Image
          src={character}
          alt="feisalKeli"
      ...
      <div className="w-1/2 flex-flex-col text-left items-start justify-center px-16">
        ...
        <p className="font-medium capitalize mt-4 text-base">
          ...
          Lasting Impact—One Pixel At A Time. Have a project in mind? Reach out
          to me 📞 from here and let's make it happen.
        </p>
      </div>
    </section>
  );
